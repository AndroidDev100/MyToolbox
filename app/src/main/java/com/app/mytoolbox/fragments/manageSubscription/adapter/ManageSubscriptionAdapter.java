package com.app.mytoolbox.fragments.manageSubscription.adapter;
...
import com.app.mytoolbox.databinding.ManageSubscriptionItemBinding;
...
public class ManageSubscriptionAdapter extends RecyclerView.Adapter<ManageSubscriptionAdapter.SingleItem> {
    ...
    public SingleItem onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        return new SingleItem(manageSubscriptionItemBinding);
    }

    @Override
    public void onBindViewHolder(@NonNull SingleItem holder, int position) {
        try {
            if (accountServiceMessageItems != null && accountServiceMessageItems.get(position) != null && accountServiceMessageItems.get(position).getDisplayName() != null)
