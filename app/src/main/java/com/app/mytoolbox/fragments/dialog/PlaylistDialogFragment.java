...
public class PlaylistDialogFragment extends DialogFragment {
    ...
    public static PlaylistDialogFragment newInstance(String title, String message) {
        PlaylistDialogFragment frag = new PlaylistDialogFragment();
...
//        return inflater.inflate(R.layout.edit_dialog_layout, container);
        ...
        View view = inflater.inflate(R.layout.playlist_dialog_layout, container);
        if (getDialog().getWindow() != null) {
            ...
            Button btnContinue = view.findViewById(R.id.btn_ok);
           ...
           // etDialog.setOnEditorActionListener(this);
            ...
            btnContinue.setOnClickListener(v -> {
                if (TextUtils.isEmpty(etDialog.getText().toString().trim())) {
                    ...
                    inputLayoutDialog.setError(getText(R.string.pls_enter_title));
...
//                    Toast.makeText(getActivity(), getResources().getString(R.string.pls_enter_device_name), Toast.LENGTH_SHORT).show();
                    ...
                    if(etDialog.getText().length()>20){
                        inputLayoutDialog.setError(getText(R.string.playlist_name_restriction));
