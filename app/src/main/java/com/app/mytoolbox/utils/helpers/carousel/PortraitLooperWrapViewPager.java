...
package com.app.mytoolbox.utils.helpers.carousel;
...
import com.app.mytoolbox.utils.helpers.carousel.adapter.PotraitLoopPagerAdapterWrapper;
 ...
 */
public class PortraitLooperWrapViewPager extends ViewPager {

    private static final boolean DEFAULT_BOUNDARY_CASHING = false;
    private static final int VELOCITY = 200;
    private OnPageChangeListener mOuterPageChangeListener;
    private PotraitLoopPagerAdapterWrapper mAdapter;
    ...
    public void setAdapter(PagerAdapter adapter) {
        mAdapter = new PotraitLoopPagerAdapterWrapper(adapter);
    ...
    public PortraitLooperWrapViewPager(Context context) {
        super(context);
        init();
    }

    public PortraitLooperWrapViewPager(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }
    ...
    private final OnPageChangeListener onPageChangeListener = new OnPageChangeListener() {
        ...
        public void onPageScrollStateChanged(int state) {
            if (mAdapter != null) {
                int position = PortraitLooperWrapViewPager.super.getCurrentItem();
