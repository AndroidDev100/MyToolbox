...
public class ShimmerRecyclerView extends RecyclerView {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        try {
            ...
            mShimmerColor = a.getColor(R.styleable.ShimmerRecyclerView_shimmer_demo_shimmer_color, ContextCompat.getColor(context, R.color.shimmer_color));
     ...
     */
    private void setGridChildCount(int count) {
        mGridCount = count;
    }
     ...
     */
    private void setDemoLayoutManager(LayoutMangerType type) {
     ...
     */
    private void setDemoLayoutReference(int mLayoutReference) {
